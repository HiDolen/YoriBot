...
music = TinyDB(data_path / "ncm_musics.json")
# setting = TinyDB("./db/ncm_setting.json")
setting = TinyDB(data_path / "ncm_setting.json")
# ncm_user_cache = TinyDB("./db/ncm_cache.json")
ncm_user_cache = TinyDB(data_path / "ncm_cache.json")
# ncm_check_cache = TinyDB("./db/ncm_check_cache.json")
ncm_check_cache = TinyDB(data_path / "ncm_check_cache.json")
Q = Query()
